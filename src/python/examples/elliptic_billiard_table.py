...
async def async_main(context):
    # resolution=[600,600]
    # translate = [200, -450]
    gui_settings = gui_settings_from_context(context)#, scale=10)# resolution=resolution, translate=translate)
    await run_example(EllipticBillardTable, gui_settings, context)